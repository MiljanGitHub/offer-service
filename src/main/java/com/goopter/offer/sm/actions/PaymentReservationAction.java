...
@Component
@AllArgsConstructor
public class PaymentReservationAction implements Action<OfferState, OfferEvent> {
    ...
    public void execute(StateContext<OfferState, OfferEvent> stateContext) {
        ...
        Optional.ofNullable(stateContext.getMessage())
                ...
                .ifPresentOrElse(offerId -> {
                            ...
                            if (o.isPresent()){
                               //TODO inform message-service that Seller's bank is processing payment and that he will get payment within 3-4 business days
